...
def run_test():
    ...
    with sync_playwright() as p:
        ...
        # Print the code of adminLoadExistingShopItem and adminUpdateShopFields
        page.evaluate("""
            console.log("adminLoadExistingShopItem code:\\n" + window.adminLoadExistingShopItem.toString());
            console.log("adminUpdateShopFields code:\\n" + window.adminUpdateShopFields.toString());
        """)
