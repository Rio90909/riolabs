...
def run_test():
    ...
    with sync_playwright() as p:
        ...
        page.evaluate("""
            ...
            console.log("Done. select value: " + sel.value);

            // Wait for setTimeout in adminLoadExistingShopItem
            setTimeout(() => {
                console.log("After 50ms setTimeout, id input value: " + document.getElementById('adminShopId').value);
                console.log("After 50ms setTimeout, name input value: " + document.getElementById('adminShopName').value);
                console.log("After 50ms setTimeout, select value: " + document.getElementById('adminShopEditSelect').value);
            }, 100);
        """)
