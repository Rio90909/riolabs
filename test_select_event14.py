...
def run_test():
    ...
    with sync_playwright() as p:
        ...
        page.evaluate("""
            ...
            sel.innerHTML += '<option value="b_test1">Test Bubble 1 (b_test1)</option>';
            sel.value = 'b_test1';

            console.log("adminShopEditSelect value is " + sel.value);
            ...
            const item = (window.shopData[cat] || []).find(i => i.id === id);
            ...
            window.adminUpdateShopFields(true);
